...
export default function Header() {
    ...
    return (
        <nav className='navbar py-2 ps-2 pe-4' style={{minHeight: '75px'}}>

            <Link className={`position-relative me-3 ${styles.logo}`} exact='true' to='/'>
                <div className={`position-absolute d-flex ${styles.logo_img_container}`}>
                    <div className={`p-2 shadow ${styles.logo_img}`}>
                        <div/>
                        <div/>
                        <div/>
                        <div/>
                ...
                <div className={`fw-bold position-relative text-center ${styles.logo_text}`}>
                    <span>Pa</span>
                    <span>pe</span>
                    <span>ry</span>
                </div>
